...
- **Try Anchor (Experimental):**  
  [Responsibility classification lesson](https://jon4ohio.github.io/anchor-lab/) — 5-minute exercise testing whether responsibility-first organization is learnable experientially ([anchor-lab](https://github.com/jon4ohio/anchor-lab))
...
- A replacement for your ADRs, docs, or `CLAUDE.md`
- A prescription for editors, tools, or integrations
